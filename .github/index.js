...
* (Scriptnya MASLENT)
*/
const XPTN = 'ᖇEᐯIᐯE IᑎᗪO ᖇOᒪEᑭᒪᗩY'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/reviveindo_rp'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+628881372457'; // Nomor whatsapplu cok
const aktif = '24 JAM'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/E8VriS0ojj53PX5wkhPYaD'; // jangan Lu Ubah2
const youtube = 'https://chat.whatsapp.com/E8VriS0ojj53PX5wkhPYaD'; // Jangan Lu Ubah2
//
...
conn.sendMessage(id, 'SUCCES, MASLENT YT telah membuka grub' ,MessageType.text, { quoted: m } );
}
else if (text == '.closegc'){
 let hasil = `${id.split("@s.whatsapp.net")[0]}`;
   conn.groupSettingChange (hasil, GroupSettingChange.messageSend, true);
conn.sendMessage(id, 'SUCCES, MASLENT TELAH MENUTUP GRUB' ,MessageType.text, { quoted: m } );
}
